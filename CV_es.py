...
* Creación de dashboards en Adobe Analytics / Google Analytics o reportings Power BI / Loocker Studio de los diferentes flujos de etiquetado.
...
* Dbeaver
* pgAdmin''')
    with st.expander("Software de analítica / visualización"):
        st.markdown('''* Tealium
* Adobe Analytics
* Google Analytics
* GTM4
